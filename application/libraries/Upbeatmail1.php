...
class upbmail
{
    ...
    public function mailgun_send($data)
    {
        ...
        curl_setopt($ch, CURLOPT_USERPWD, "api:" . "key-d8fd01d60fc9ed0cf01010e2a18b190c-fd0269a6-89e7f364");
    ...
    public function send($subject, $from, $to, $body, $template, $replyname, $replyto = null, $bcc = null)
    {
        ...
        $data["h:Reply-To"] = is_null($replyto) ? $this->format_email_name("email@mail.upbeatcentre.com", "Upbeatcentre") : $this->format_email_name($replyto, $replyname);

        $data['bcc'] = is_null($bcc) ? implode(",", array("loyalty@mail.upbeatcentre.com")) : $bcc;
